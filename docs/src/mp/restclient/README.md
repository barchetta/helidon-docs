...
| [Rest Client Metrics](restclientmetrics.md) | Helidon supports MicroProfile REST Client metrics by registering metrics automatically when developers add MicroProfile Metrics annotations to REST client interfaces and methods.      |
