...
- Removed Helidon’s Reactive WebServer and WebClient that were based on Netty. Our new implementations are based on virtual threads that have a blocking style API (Project Níma). Learn more: [Helidon 4 WebServer.](#_helidon_4_webserver)

- Converted other *reactive* API modules to *blocking* style APIs. The `io.helidon.common.reactive` APIs will stay as general purpose reactive utilities and operators. Learn more: [Helidon SE](#_helidon_se)

- Upgraded MicroProfile support to MicroProfile 6 and Jakarta 10 Core Profile running on the Helidon WebServer. Learn more: [Helidon MP](#_helidon_mp)
